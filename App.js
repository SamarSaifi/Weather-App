...
async function getWeather() {
    try {
        ...
        const extractedDateTime = date.slice(0, 16); // Adjust the slice range to include the full date and time
...
document.addEventListener("DOMContentLoaded", function () {
    getWeather();
    setInterval(getWeather, 900000); // Update weather data every 15 minutes (900000 milliseconds)
});